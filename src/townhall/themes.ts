...
export const THEMES: Record<ThemeId, Theme> = {
  ...
  brand: {
    id: "brand",
    name: "Brand",
    tagline: "CampMinder Learning Hub. Native.",
    bg: "#F8F9FA",
    fg: "#1A1A1A",
    fgMuted: "#4B5563",
    fgSubtle: "#6B7280",
    ...
    positive: "#059669",
    negative: "#DC2626",
    fontHeading: 'var(--font-sans), "Space Grotesk", "Inter", system-ui, sans-serif',
    fontBody: 'var(--font-sans), "Space Grotesk", "Inter", system-ui, sans-serif',
